...
FILE_URL="https://raw.githubusercontent.com/google/it-cert-automation-practice/$
...
def get_same_or_newer(start_date, data):
    """Go through all the data and find the employees that started on
the given date, or the closest one. Do not include dates after today."""
    my_date_employees = {}
    for key in data:
        name = data[key]
